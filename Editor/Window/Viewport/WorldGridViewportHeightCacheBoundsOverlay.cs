...
internal sealed class WorldGridViewportHeightCacheBoundsOverlay :
    ...
    IWorldGridViewportOverlayInvalidationSource
{
    ...
    private readonly WorldGridViewportHeightCacheBoundsProvider provider =
        new WorldGridViewportHeightCacheBoundsProvider();

    public event Action<string> OverlayInvalidated;

    internal WorldGridViewportHeightCacheBoundsOverlay()
    {
