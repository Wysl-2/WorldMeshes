...
internal sealed class WorldGridViewportClipmapBoundsOverlay :
    ...
    IWorldGridViewportOverlayInvalidationSource
{
    ...
    private readonly WorldGridViewportClipmapBoundsProvider provider =
        new WorldGridViewportClipmapBoundsProvider();

    public event Action<string> OverlayInvalidated;

    internal WorldGridViewportClipmapBoundsOverlay()
    {
