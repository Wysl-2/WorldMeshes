    ...
    private static void ValidateEnumAndCompilerContract()
    {
        ...
        Add(
            ...
            TerrainGenerationStateUtility
                .RuntimeHeightCompilerVersion == 9,
            $"RuntimeHeightCompilerVersion={TerrainGenerationStateUtility.RuntimeHeightCompilerVersion}; expected 9 for the current Package 2 base."
        );
