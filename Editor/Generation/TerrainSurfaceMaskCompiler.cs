...
public static class TerrainSurfaceMaskCompiler
{
    ...
    // =====================================================
    // SUITABILITY CPU EVALUATION
    // =====================================================

    /*
     * The expensive raw measurements come from Terrain Analysis readbacks.
     * Only the lightweight final rule evaluation happens on the CPU here.
     * These functions mirror ClipmapTerrainSuitability.hlsl.
     */

    private static float EvaluateScreeSuitability(
        ScreeBakeSettings scree,
        Vector2 worldXZ,
        float slopeDegrees,
        float curvature
    )
    ...
    private readonly struct ScreeBakeSettings
    {
    ...
    private sealed class BuildState
    {
        ...
        private readonly ScreeBakeSettings screeSettings;
